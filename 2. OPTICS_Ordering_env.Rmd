...
opticsObjs = list()
cols = 5:7 # Columns of each data sheet containing data that should be used in the clustering. Adjust to 6:7 to get ordering without considering FSC dimension.
...
for (i in 1:x) {
  ...
  for (j in 1:y) {
    ...
    # saveFileName = gsub("Rep","noFSC_Rep",saveFileName) # Uncomment if not considering FSC dimension
